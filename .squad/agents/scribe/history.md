...
- **Role:** Session Logger
- **Joined:** 2026-05-27T15:26:08.972Z
...
- 2026-07-06: Session records should describe the current root-level Go layout: `go.mod` at repo root, code under `cmd/` and `internal/`, plans under `docs/`, Windows build via `build_transcribe_win64.bat`, and generated artifacts under `build/windows-amd64/`; old `transcribe/` navigation is obsolete except stale `transcribe/build/` artifacts.
